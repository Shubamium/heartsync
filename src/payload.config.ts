...
import About from "./collections/global/About";
import PrivacyPolicy from "./collections/global/PrivacyPolicy";
export default buildConfig({
  ...
  globals: [Home, About, Audition, Guidelines, PrivacyPolicy],
